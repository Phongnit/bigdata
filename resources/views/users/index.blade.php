                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <a class="button btn-success" href="{{ route('users.create') }}">Thêm mới</a>
                                        ...
                                        <tbody>
                                            @foreach ($user as $user)
                                                <tr>
                                                    ...
                                                    <td class="mailbox-subject">{{ $user->role->name }}</td>
                                                    {{-- <td class="mailbox-date">{{ $user->created_at->format('d/m/Y') }}</td> --}}
                                                    <td><a href="{{ route('users.show', ['id' => $user->id]) }}"><i class="text-success fas fa-eye"></i></a>
                                                        <a href="{{ route('users.edit', ['id' => $user->id]) }}"><i class="text-primary fas fa-edit"></i></a>
